    ...
    try:
        ...
        with psycopg2.connect(database_url) as connection:
            ...
            with connection.cursor() as cursor:
                ...
                cursor.execute("INSERT INTO students VALUES('rauniyar7', 'Sriyanssssssss', '8888888888', 'rauniyar@princeton.edu', 'junior')")
                cursor.execute("INSERT INTO students VALUES('rauniyar7', 'Sriyanssssssss', '8888888888', 'rauniyar@princeton.edu', 'junior')")
                cursor.execute("INSERT INTO students VALUES('rauniyar7', 'Sriyanssssssss', '8888888888', 'rauniyar@princeton.edu', 'junior')")
                ...
                cursor.execute("INSERT INTO events VALUES (4, 'This Break', '9:00', '10:40', 3, 'Karim', 'Category 1', 'Peyton Hall', 'Description 1', 3, '2022/11/09', '2022/10/23', 1)")
                cursor.execute("INSERT INTO events VALUES (5, 'That Break', '10:40', '12:30', 15, 'Nada', 'Category 7', 'Lovely Hall', 'Description 1', 5, '2022/11/10', '2021/10/24', 1)")
                cursor.execute("INSERT INTO events VALUES (6, 'Headache', '00:00', '23:59', 3, 'Sriyans', 'Category 1', 'Fancy Hall', 'Description 9', 1, '2022/11/11', '2022/08/09', 1)")
                cursor.execute("INSERT INTO events VALUES (7, 'No Break', '00:00', '00:01', 3, 'Anca', 'Category 1', 'Okay Hall', 'Description 6', 1, '2022/11/12', '2022/11/13', 1)")
                cursor.execute("INSERT INTO events VALUES (8, 'Long Break', '09:00', '23:00', 1, 'Karim', 'Category 3', 'Not okay Hall', 'Description 1', 1, '2022/11/11', '2022/12/27', 1)")
                ...
                cursor.execute("INSERT INTO students VALUES('rauniyar1', 'Sriyans', '9999999999', 'rauniyar@princeton.edu', 'sophomore')")
                cursor.execute("INSERT INTO students VALUES('rauniyar2', 'Sriyans', '9999999999', 'rauniyar@princeton.edu', 'sophomore')")
                cursor.execute("INSERT INTO students VALUES('rauniyar3', 'Sriyans', '9999999999', 'rauniyar@princeton.edu', 'sophomore')")
                cursor.execute("INSERT INTO students VALUES('rauniyar4', 'Sriyans', '9999999999', 'rauniyar@princeton.edu', 'sophomore')")
                cursor.execute("INSERT INTO students VALUES('rauniyar5', 'Sriyans', '9999999999', 'rauniyar@princeton.edu', 'sophomore')")
                cursor.execute("INSERT INTO students VALUES('rauniyar6', 'Sriyans', '9999999999', 'rauniyar@princeton.edu', 'junior')")
                cursor.execute("INSERT INTO students VALUES('rauniyar6', 'Sriyans', '8888888888', 'rauniyar@princeton.edu', 'junior')")
